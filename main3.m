...
fprintf("Miss distance target at 150m, 40 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 150, 40/3.6).miss_distance);
fprintf("Miss distance target at 250m, 0 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 250, 0/3.6).miss_distance);
fprintf("Miss distance target at 250m, 40 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 250, 40/3.6).miss_distance);
fprintf("Miss distance target at 500m, 0 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 500, 0/3.6).miss_distance);
fprintf("Miss distance target at 500m, 40 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 500, 40/3.6).miss_distance);
fprintf("Miss distance target at 750m, 0 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 750, 0/3.6).miss_distance);
fprintf("Miss distance target at 750m, 40 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 750, 40/3.6).miss_distance);
fprintf("Miss distance target at 1000m, 0 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 1000, 0/3.6).miss_distance);
fprintf("Miss distance target at 1000m, 40 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 1000, 40/3.6).miss_distance);
fprintf("Miss distance target at 1500m, 0 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 1500, 0/3.6).miss_distance);
fprintf("Miss distance target at 1500m, 40 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 1500, 40/3.6).miss_distance);
fprintf("Miss distance target at 2000m, 0 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 2000, 0/3.6).miss_distance);
fprintf("Miss distance target at 2000m, 40 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 2000, 40/3.6).miss_distance);
fprintf("Miss distance target at 2500m, 0 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 2500, 0/3.6).miss_distance);
fprintf("Miss distance target at 2500m, 40 km/h: %g m\n", guidance_low_range(params, PID, Kaz_lr(1:3), Kaz(4:6), 2500, 40/3.6).miss_distance);

res = guidance_low_range(params, PID, Kaz_lr(1:3), Kaz_lr(4:6), 1500, 0/3.6);
%res = tune_az_autopilot_low_range(params, PID, Kaz_lr(1:3), Kaz_lr(4:6), 30);
